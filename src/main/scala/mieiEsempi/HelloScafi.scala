...
object HelloScafi extends App {
  val program = new BasicUsageProgram() //guarda punto 3. , il quale estende AggregateProgram
  ...
  val c2 = factory.context(0, Map(0 -> e1)) //con Map nel quale abbiamo coppia key value alla chiave 0 è associato l'export e1
